...
base_model.save(RUN_DIR / "base_model.keras")
base_model_path = RUN_DIR / "base_model.keras"
base_model_size = os.path.getsize(base_model_path) / (1024 * 1024)
print(f"Base Keras model file size:               {base_model_size:.2f} MB")
...
final_model_path = RUN_DIR / "pruned_model.keras"
final_model_size = os.path.getsize(final_model_path) / (1024 * 1024)
print(f"Base Keras model file size:               {final_model_size:.2f} MB")
...
q_aware_model_size = os.path.getsize(q_aware_model_path) / (1024 * 1024)
print(f"Base Keras model file size:               {q_aware_model_size:.2f} MB")
...
try:
    ...
    q_lite_size = os.path.getsize(q_lite_path) / (1024 * 1024)
    print(f"Base Keras model file size:               {q_lite_size:.2f} MB")
